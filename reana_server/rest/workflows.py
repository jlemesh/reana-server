...
@blueprint.route("/workflows/<workflow_id_or_name>/job/<job_id>/logs", methods=["GET"])
@signin_required()
def get_job_logs(workflow_id_or_name, job_id, user, **kwargs):  # noqa
    ...
    ---
    get:
      summary: Get job logs of a workflow.
      description: >-
        This resource reports the status of a workflow.
        Resource is expecting a workflow UUID.
      ...
      parameters:
        ...
        - name: job_id
          in: path
          description: Required. Job UUID or name.
          required: true
          type: string
      responses:
        200:
